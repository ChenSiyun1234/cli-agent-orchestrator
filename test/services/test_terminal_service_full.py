...
class TestCreateTerminal:
    ...
    @patch("cli_agent_orchestrator.services.terminal_service.generate_terminal_id")
    @patch("cli_agent_orchestrator.services.terminal_service.load_agent_profile")
    async def test_create_terminal_persists_and_forwards_hermes_effort(
        self,
        mock_load_profile,
        mock_gen_id,
        mock_gen_session,
        ...
        assert mock_provider_manager.create_provider.call_args.kwargs["reasoning_effort"] == "max"
        assert mock_db_create.call_args.kwargs["metadata"] == {"launch_reasoning_effort": "max"}
